import{r as a,j as e}from"./index-BuqDSfFw.js";const ie={mercedes:"#00D7B6",ferrari:"#E8002D",mclaren:"#FF8000",red_bull:"#3671C6",rb:"#6692FF",alpine:"#00A1E8",haas:"#B6BABD",audi:"#BB0A30",williams:"#64C4FF",aston_martin:"#229971",cadillac:"#C6A664"},v=n=>ie[n]||"#8A8A96",K="https://api.jolpi.ca/ergast/f1",oe=6.5,le=9e3,B=n=>String(n).padStart(2,"0"),F=n=>new Date(n).toLocaleDateString("en-GB",{day:"numeric",month:"short"}),ce=n=>new Date(n).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"});function g({children:n,className:r="",delay:u=0}){const h=a.useRef(null),[f,l]=a.useState(!1);return a.useEffect(()=>{const N=h.current;if(!N)return;const j=new IntersectionObserver(([C])=>{C.isIntersecting&&(l(!0),j.disconnect())},{threshold:.1,rootMargin:"0px 0px -6% 0px"});return j.observe(N),()=>j.disconnect()},[]),e.jsx("div",{ref:h,className:r,style:{opacity:f?1:0,transform:f?"translateY(0)":"translateY(-26px)",transition:`opacity .8s cubic-bezier(.22,.61,.36,1) ${u}s, transform .8s cubic-bezier(.22,.61,.36,1) ${u}s`},children:n})}function de(n){const r=a.useMemo(()=>n?new Date(n).getTime():null,[n]),[u,h]=a.useState(()=>Date.now());if(a.useEffect(()=>{if(!r||r-Date.now()<=0)return;const l=setInterval(()=>h(Date.now()),1e3);return()=>clearInterval(l)},[r]),!r)return null;const f=r-u;return f<=0?{past:!0,d:0,h:0,m:0,s:0}:{past:!1,d:Math.floor(f/864e5),h:Math.floor(f/36e5%24),m:Math.floor(f/6e4%60),s:Math.floor(f/1e3%60)}}const D=()=>e.jsx("div",{className:"f1-kerb","aria-hidden":"true"}),m=({children:n,id:r})=>e.jsx("section",{id:r,className:"max-w-3xl mx-auto px-5 sm:px-6 py-7 sm:py-9",children:n}),y=({children:n,note:r})=>e.jsxs("div",{className:"flex items-baseline justify-between gap-4 mb-5",children:[e.jsxs("h2",{className:"f1-h2",children:[e.jsx("span",{className:"f1-tick","aria-hidden":"true"}),n]}),r&&e.jsx("span",{className:"f1-note shrink-0",children:r})]});function R({pos:n,color:r,name:u,sub:h,points:f,wins:l,pct:N,lead:j}){return e.jsxs("div",{className:`f1-row${j?" f1-row-lead":""}`,children:[e.jsx("span",{className:"f1-bar",style:{width:`${N}%`,background:r},"aria-hidden":"true"}),e.jsx("span",{className:"f1-pos",children:n}),e.jsx("span",{className:"f1-stripe",style:{background:r},"aria-hidden":"true"}),e.jsxs("span",{className:"min-w-0 flex-1 relative",children:[e.jsx("span",{className:"block text-[14.5px] font-medium leading-tight truncate",children:u}),h&&e.jsx("span",{className:"f1-sub block truncate",children:h})]}),l>0&&e.jsxs("span",{className:"f1-wins",children:[l,"W"]}),e.jsx("span",{className:"f1-pts",children:f})]})}function me({onBack:n}){var G,H,V,Y,U;const[r,u]=a.useState(void 0),[h,f]=a.useState(!1),[l,N]=a.useState("film"),[j,C]=a.useState(!1),[Q,Z]=a.useState(!1),[M,L]=a.useState(!1),[E,$]=a.useState(!1),[P,I]=a.useState(!1),[S,ee]=a.useState(!1),w=a.useRef(null),x=a.useCallback(()=>{N("open"),C(!0)},[]);a.useEffect(()=>{const s=window.matchMedia("(prefers-reduced-motion: reduce)"),t=i=>{ee(i),i&&x()};t(s.matches);const c=i=>t(i.matches);return s.addEventListener("change",c),()=>s.removeEventListener("change",c)},[x]),a.useEffect(()=>{let s=!0;return fetch("/f1.json").then(t=>t.ok?t.json():Promise.reject(new Error(String(t.status)))).then(t=>s&&u(t)).catch(()=>s&&u(null)),()=>{s=!1}},[]),a.useEffect(()=>{if(!(r!=null&&r.season))return;let s=!0;return Promise.all([fetch(`${K}/${r.season}/driverstandings/?format=json`).then(t=>t.json()),fetch(`${K}/${r.season}/constructorstandings/?format=json`).then(t=>t.json())]).then(([t,c])=>{var T;if(!s)return;const i=t.MRData.StandingsTable.StandingsLists[0],z=c.MRData.StandingsTable.StandingsLists[0];(T=i==null?void 0:i.DriverStandings)!=null&&T.length&&(u(X=>({...X,round:Number(i.round)||X.round,drivers:i.DriverStandings.map(o=>{var q,J;return{pos:Number(o.position),points:Number(o.points),wins:Number(o.wins),code:o.Driver.code||o.Driver.familyName.slice(0,3).toUpperCase(),first:o.Driver.givenName,last:o.Driver.familyName,team:((q=o.Constructors[o.Constructors.length-1])==null?void 0:q.name)||"",teamId:((J=o.Constructors[o.Constructors.length-1])==null?void 0:J.constructorId)||""}}),constructors:((z==null?void 0:z.ConstructorStandings)||[]).map(o=>({pos:Number(o.position),points:Number(o.points),wins:Number(o.wins),name:o.Constructor.name,teamId:o.Constructor.constructorId}))})),f(!0))}).catch(()=>{}),()=>{s=!1}},[r==null?void 0:r.season]),a.useEffect(()=>{const s=w.current;!s||S||(s.volume=1,s.muted=!1,s.play().then(()=>L(!1)).catch(()=>{s.muted=!0,L(!0),$(!0),s.play().catch(()=>x())}))},[S,x]),a.useEffect(()=>{if(!E)return;const s=()=>{const t=w.current;t&&(t.muted=!1,t.volume=1,t.play().catch(()=>{}),L(!1)),$(!1)};return window.addEventListener("pointerdown",s,{once:!0}),window.addEventListener("keydown",s,{once:!0}),()=>{window.removeEventListener("pointerdown",s),window.removeEventListener("keydown",s)}},[E]),a.useEffect(()=>{if(l!=="film")return;const s=document.body.style.overflow;return document.body.style.overflow="hidden",window.scrollTo(0,0),()=>{document.body.style.overflow=s}},[l]),a.useEffect(()=>{if(l!=="film")return;const s=setTimeout(()=>Z(!0),3500),t=setTimeout(()=>{const c=w.current;(!c||c.paused||c.currentTime===0)&&x()},le);return()=>{clearTimeout(s),clearTimeout(t)}},[l,x]);const se=a.useCallback(()=>{const s=w.current;!(s!=null&&s.duration)||Number.isNaN(s.duration)||s.currentTime>=s.duration-oe&&C(!0)},[]),re=a.useCallback(()=>{I(!1),x()},[x]),A=a.useCallback(()=>{const s=w.current;s&&(s.muted=!s.muted,s.muted||(s.volume=1),L(s.muted),$(!1),s.paused&&s.play().catch(()=>{}))},[]),te=a.useCallback(()=>{const s=w.current;s&&(s.paused?(s.ended&&(s.currentTime=0),s.play().catch(()=>{})):s.pause())},[]),d=a.useMemo(()=>{if(!(r!=null&&r.races))return null;const s=Date.now();return r.races.find(t=>new Date(t.start).getTime()>s)||null},[r]),b=de(d==null?void 0:d.start),k=a.useMemo(()=>((r==null?void 0:r.races)||[]).filter(s=>new Date(s.start).getTime()<Date.now()),[r]),W=a.useMemo(()=>{if(!(r!=null&&r.drivers))return[];const s=new Map;for(const t of r.drivers)t.teamId&&(s.has(t.teamId)||s.set(t.teamId,[]),s.get(t.teamId).push(t));return[...s.entries()].map(([t,c])=>{const i=[...c].sort((z,T)=>T.points-z.points).slice(0,2);return i.length===2?{teamId:t,team:i[0].team,a:i[0],b:i[1],total:i[0].points+i[1].points}:null}).filter(Boolean).sort((t,c)=>c.total-t.total)},[r]),p=((G=r==null?void 0:r.drivers)==null?void 0:G.length)>=2?{p1:r.drivers[0],p2:r.drivers[1]}:null,O=r!=null&&r.races?r.races.length-k.length:0,ae=((V=(H=r==null?void 0:r.drivers)==null?void 0:H[0])==null?void 0:V.points)||1,ne=((U=(Y=r==null?void 0:r.constructors)==null?void 0:Y[0])==null?void 0:U.points)||1,_="/";return e.jsxs("div",{className:"f1-root",children:[e.jsx("div",{className:"f1-bg","aria-hidden":"true"}),e.jsxs("button",{onClick:n,title:"Back",className:"f1-back",children:[e.jsx("svg",{className:"w-4 h-4",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:2.2,children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M15 19l-7-7 7-7"})}),e.jsx("span",{className:"hidden sm:inline",children:"Back"})]}),e.jsxs("div",{className:"f1-hero",children:[e.jsx("video",{ref:w,className:"f1-video",src:`${_}f1/hero.mp4`,poster:`${_}f1/poster.jpg`,playsInline:!0,preload:"auto",autoPlay:!S,onTimeUpdate:se,onEnded:re,onError:x,onPlay:()=>I(!0),onPause:()=>I(!1)}),e.jsx("div",{className:"f1-scrim","aria-hidden":"true"}),e.jsxs("div",{className:"f1-hero-inner",children:[e.jsx("div",{className:`f1-title${j?" f1-title-in":""}`,children:e.jsxs("h1",{className:"f1-h1",children:["Formula 1",e.jsx("span",{className:"f1-h1-kerb","aria-hidden":"true"})]})}),l==="open"&&e.jsxs("button",{onClick:()=>{var s;return(s=document.getElementById("f1-details"))==null?void 0:s.scrollIntoView({behavior:S?"auto":"smooth",block:"start"})},className:"f1-cue","aria-label":"Scroll to the championship",children:[e.jsx("span",{className:"f1-cue-text",children:"The standings"}),e.jsx("svg",{className:"w-5 h-5 f1-bob",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:1.8,children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M19 14l-7 7m0 0l-7-7m7 7V3"})})]})]}),E&&l==="film"&&e.jsxs("button",{onClick:A,className:"f1-sound-prompt",children:[e.jsxs("svg",{className:"w-4 h-4",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:1.9,children:[e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M11 5L6 9H3v6h3l5 4V5z"}),e.jsx("path",{strokeLinecap:"round",d:"M15.5 8.5a5 5 0 010 7M18 6a8.5 8.5 0 010 12"})]}),"Tap for sound"]}),l==="film"&&Q&&e.jsxs("button",{onClick:x,className:"f1-skip",children:["Skip the film",e.jsx("svg",{className:"w-3.5 h-3.5",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:2,children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M13 5l7 7-7 7M5 5l7 7-7 7"})})]}),e.jsxs("div",{className:"f1-controls",children:[e.jsx("button",{onClick:te,className:"f1-ctl","aria-label":P?"Pause the film":"Play the film",children:P?e.jsxs("svg",{className:"w-4 h-4",viewBox:"0 0 24 24",fill:"currentColor",children:[e.jsx("rect",{x:"6",y:"5",width:"4",height:"14",rx:"1"}),e.jsx("rect",{x:"14",y:"5",width:"4",height:"14",rx:"1"})]}):e.jsx("svg",{className:"w-4 h-4",viewBox:"0 0 24 24",fill:"currentColor",children:e.jsx("path",{d:"M8 5.5v13l11-6.5z"})})}),e.jsx("button",{onClick:A,className:`f1-ctl${M?"":" f1-ctl-on"}`,"aria-label":M?"Unmute the film":"Mute the film",children:M?e.jsxs("svg",{className:"w-4 h-4",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:1.9,children:[e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M11 5L6 9H3v6h3l5 4V5z"}),e.jsx("path",{strokeLinecap:"round",d:"M17 9l4 6m0-6l-4 6"})]}):e.jsxs("svg",{className:"w-4 h-4",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:1.9,children:[e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M11 5L6 9H3v6h3l5 4V5z"}),e.jsx("path",{strokeLinecap:"round",d:"M15.5 8.5a5 5 0 010 7M18 6a8.5 8.5 0 010 12"})]})})]})]}),l==="open"&&e.jsxs("div",{id:"f1-details",className:"f1-details",children:[e.jsx(D,{}),r===void 0&&e.jsx(m,{children:e.jsx("div",{className:"f1-state",children:"Warming the tyres…"})}),r===null&&e.jsx(m,{children:e.jsx("div",{className:"f1-state",children:"Couldn’t load the championship right now."})}),r&&e.jsxs(e.Fragment,{children:[e.jsx(m,{children:e.jsx(g,{children:e.jsxs("div",{className:"f1-pulse",children:[e.jsxs("div",{className:"f1-pulse-head",children:[e.jsxs("span",{className:"f1-pulse-round",children:["Round ",e.jsx("b",{children:k.length})," of ",r.races.length]}),e.jsxs("span",{className:"f1-note",children:[O," to go"]})]}),e.jsx("div",{className:"f1-track",role:"img","aria-label":`${k.length} of ${r.races.length} rounds complete`,children:e.jsx("span",{className:"f1-track-fill",style:{width:`${k.length/r.races.length*100}%`}})}),e.jsxs("div",{className:"f1-pulse-grid",children:[e.jsxs("div",{children:[e.jsx("b",{children:r.drivers.reduce((s,t)=>s+t.wins,0)}),e.jsx("span",{children:"races won"})]}),e.jsxs("div",{children:[e.jsx("b",{children:new Set(k.map(s=>{var t;return(t=s.winner)==null?void 0:t.last}).filter(Boolean)).size}),e.jsx("span",{children:"winners"})]}),e.jsxs("div",{children:[e.jsx("b",{children:new Set(r.races.map(s=>s.country)).size}),e.jsx("span",{children:"countries"})]}),e.jsxs("div",{children:[e.jsx("b",{children:r.constructors.length}),e.jsx("span",{children:"teams"})]})]})]})})}),d&&e.jsx(m,{children:e.jsx(g,{children:e.jsxs("div",{className:"f1-next",children:[e.jsxs("div",{className:"f1-next-tag",children:["Next up · Round ",d.round]}),e.jsx("h2",{className:"f1-next-name",children:d.name}),e.jsxs("p",{className:"f1-next-where",children:[d.circuit," · ",d.locality,", ",d.country,e.jsx("span",{className:"f1-dot",children:"·"}),F(d.start),", ",ce(d.start)]}),b&&!b.past&&e.jsx("div",{className:"f1-clock",children:[["Days",b.d],["Hrs",B(b.h)],["Min",B(b.m)],["Sec",B(b.s)]].map(([s,t])=>e.jsxs("div",{className:"f1-clock-cell",children:[e.jsx("div",{className:"f1-clock-num",children:t}),e.jsx("div",{className:"f1-clock-lab",children:s})]},s))}),(b==null?void 0:b.past)&&e.jsx("p",{className:"f1-sub",children:"Lights out."})]})})}),p&&e.jsx(m,{children:e.jsxs(g,{children:[e.jsx(y,{note:`${O} rounds left`,children:"The title race"}),e.jsxs("div",{className:"f1-duel",children:[e.jsxs("div",{className:"f1-duel-side",children:[e.jsx("span",{className:"f1-duel-pos",children:"P1"}),e.jsx("span",{className:"f1-duel-name",style:{color:v(p.p1.teamId)},children:p.p1.last}),e.jsx("span",{className:"f1-duel-pts",children:p.p1.points}),e.jsx("span",{className:"f1-sub",children:p.p1.team})]}),e.jsxs("div",{className:"f1-duel-gap",children:[e.jsx("b",{children:p.p1.points-p.p2.points}),e.jsx("span",{children:"points"})]}),e.jsxs("div",{className:"f1-duel-side",children:[e.jsx("span",{className:"f1-duel-pos",children:"P2"}),e.jsx("span",{className:"f1-duel-name",style:{color:v(p.p2.teamId)},children:p.p2.last}),e.jsx("span",{className:"f1-duel-pts",children:p.p2.points}),e.jsx("span",{className:"f1-sub",children:p.p2.team})]})]})]})}),e.jsx(D,{}),e.jsx(m,{children:e.jsxs(g,{children:[e.jsx(y,{note:h?"live":`after round ${r.round}`,children:"Drivers"}),e.jsx("div",{className:"space-y-1",children:r.drivers.map(s=>e.jsx(R,{pos:s.pos,color:v(s.teamId),name:`${s.first} ${s.last}`,sub:s.team,points:s.points,wins:s.wins,pct:s.points/ae*100,lead:s.pos===1},`${s.code}-${s.pos}`))})]})}),e.jsx(m,{children:e.jsxs(g,{children:[e.jsx(y,{note:`${r.constructors.length} teams`,children:"Constructors"}),e.jsx("div",{className:"space-y-1",children:r.constructors.map(s=>e.jsx(R,{pos:s.pos,color:v(s.teamId),name:s.name,points:s.points,wins:s.wins,pct:s.points/ne*100,lead:s.pos===1},s.teamId))})]})}),W.length>0&&e.jsx(m,{children:e.jsxs(g,{children:[e.jsx(y,{note:"points split",children:"Teammates"}),e.jsx("div",{className:"space-y-2.5",children:W.map(s=>{const t=s.total>0?s.a.points/s.total*100:0;return e.jsxs("div",{className:"f1-mate",children:[e.jsxs("div",{className:"f1-mate-head",children:[e.jsx("span",{className:"f1-mate-team",style:{color:v(s.teamId)},children:s.team}),e.jsxs("span",{className:"f1-note",children:[s.total," pts"]})]}),e.jsx("div",{className:"f1-mate-bar",children:e.jsx("span",{className:"f1-mate-fill",style:{width:`${t}%`,background:v(s.teamId)}})}),e.jsxs("div",{className:"f1-mate-feet",children:[e.jsxs("span",{children:[s.a.last," ",e.jsx("b",{children:s.a.points})]}),e.jsxs("span",{children:[e.jsx("b",{children:s.b.points})," ",s.b.last]})]})]},s.teamId)})})]})}),e.jsx(D,{}),k.some(s=>s.winner)&&e.jsx(m,{children:e.jsxs(g,{children:[e.jsx(y,{note:"winner · pole",children:"The season so far"}),e.jsx("div",{className:"space-y-1",children:k.filter(s=>s.winner).map(s=>e.jsxs("div",{className:"f1-past",children:[e.jsx("span",{className:"f1-pos",children:s.round}),e.jsxs("span",{className:"min-w-0 flex-1",children:[e.jsx("span",{className:"block text-[14px] leading-tight truncate",children:s.name}),e.jsxs("span",{className:"f1-sub block truncate",children:[e.jsx("b",{style:{color:v(s.winner.teamId)},children:s.winner.last}),e.jsx("span",{className:"f1-dot",children:"·"}),s.winner.team]})]}),s.pole&&e.jsxs("span",{className:"f1-pole",title:`Pole: ${s.pole.last} ${s.pole.time}`,children:[e.jsx("span",{className:"f1-pole-tag",children:"P"}),s.pole.last]})]},s.round))})]})}),r.lastRace&&e.jsx(m,{children:e.jsxs(g,{children:[e.jsx(y,{note:F(r.lastRace.date),children:"Last time out"}),e.jsxs("p",{className:"f1-sub -mt-3 mb-4",children:[r.lastRace.name," · ",r.lastRace.circuit]}),e.jsx("div",{className:"space-y-1",children:r.lastRace.podium.map(s=>e.jsx(R,{pos:s.pos,color:v(s.teamId),name:`${s.first} ${s.last}`,sub:`${s.team} · ${s.time}`,points:s.points,wins:0,pct:s.points/(r.lastRace.podium[0].points||1)*100,lead:s.pos===1},s.code))}),r.lastRace.fastestLap&&e.jsxs("p",{className:"f1-note mt-3.5",children:["Fastest lap — ",r.lastRace.fastestLap.driver," ",r.lastRace.fastestLap.time]})]})}),e.jsx(m,{children:e.jsxs(g,{children:[e.jsx(y,{note:`${r.races.length} rounds`,children:"The calendar"}),e.jsx("div",{className:"space-y-1",children:r.races.map(s=>{const t=new Date(s.start).getTime()<Date.now(),c=d&&s.round===d.round;return e.jsxs("div",{className:`f1-cal${t?" f1-cal-past":""}${c?" f1-cal-next":""}`,children:[e.jsx("span",{className:"f1-pos",children:s.round}),e.jsxs("span",{className:"min-w-0 flex-1",children:[e.jsx("span",{className:"block text-[14.5px] leading-tight truncate",children:s.name}),e.jsxs("span",{className:"f1-sub block truncate",children:[s.locality,", ",s.country]})]}),e.jsx("span",{className:"f1-cal-date",children:F(s.start)})]},s.round)})})]})}),e.jsx(D,{}),e.jsx(m,{children:e.jsx(g,{children:e.jsxs("div",{className:"f1-credits",children:[e.jsxs("p",{children:["Film: ",e.jsx("b",{children:"AMD Radeon PRO × Blender"})," for the Mercedes-AMG Petronas F1 Team, marking eight consecutive constructors’ titles (2014–2021). Rendered with Blender on an AMD Radeon PRO W6800. All rights belong to their owners; it is used here as a fan tribute, trimmed and re-encoded for the web."]}),e.jsxs("p",{children:["Timing and standings from"," ",e.jsx("a",{href:"https://api.jolpi.ca/ergast/f1/",target:"_blank",rel:"noopener noreferrer",children:"Jolpica-F1"}),", the community successor to Ergast. Not affiliated with Formula 1, the FIA, or any team."]}),r.generated&&e.jsxs("p",{className:"f1-note",children:["Snapshot ",new Date(r.generated).toLocaleDateString("en-GB",{day:"numeric",month:"short",year:"numeric"}),h?" · standings refreshed live":""]})]})})})]})]}),e.jsx("style",{children:`
        .f1-root {
          --f1-red: #E10600;
          --f1-bg: #0A0A0C;
