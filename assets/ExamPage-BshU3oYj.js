import{r as o,j as e,W as k}from"./index-BwNsXtTL.js";const v="#C0392B",j="#2E2A26",N="#6A625B",A="#FBF7EE",S="https://fonts.googleapis.com/css2?family=Caveat:wght@500;600;700&display=swap",z="'Caveat', 'Segoe Script', 'Bradley Hand', cursive",i=[{n:1,marks:20,paper:"Paper I — Data Structures & Algorithms",q:"The candidate executed the following at 2 AM. Identify the fault.",code:`def revise(syllabus):
    if panic:
...
'hmm, that depends on a few factors…'`,opts:["A hallucination","A severe hallucination","Model collapse — roll back to the last good checkpoint","All of the above. Deprecate the model and retrain it on facts."],note:"Correct. Model deprecated."},{n:4,marks:15,paper:"Paper IV — Cloud Computing",q:"Account for the third packet.",code:`$ ping amrutha
64 bytes  time=0.4 ms
64 bytes  time=0.3 ms
64 bytes  time=14h 22m`,opts:["Network congestion","Packet loss upstream","The packet arrived. It was read. No acknowledgement was sent.","All of the above. Documented behaviour. Will not be fixed."],note:"Correct. Closed as wontfix."},{n:5,marks:15,paper:"Section E — General Studies",q:"The candidate’s phone, throughout exam week, has been:",opts:["On Do Not Disturb","Face down, screen dimmed","Face down — but checked anyway, for one particular name","All of the above. The examiner has no further questions."],note:"Correct. No follow-up."},{n:6,marks:15,paper:"Bonus — Post-Deployment",q:"On successful completion of the above, the candidate is to be released to production at:",opts:["Sri Lanka — Ella, for the Nine Arch Bridge and the blue train","Sri Lanka — Sigiriya, a palace on a rock, climbed before the heat","Sri Lanka — Mirissa, blue whales, before breakfast","Sri Lanka — all three, plus Galle. Nine days. Book it before the results are out."],note:"Correct. Approved. Book it."}],l=i.reduce((m,r)=>m+r.marks,0);function E({onBack:m}){const[r,x]=o.useState({}),[c,h]=o.useState(!1),f=o.useRef(null);o.useEffect(()=>{if(document.querySelector("link[data-hand-font]"))return;const t=document.createElement("link");t.rel="stylesheet",t.href=S,t.setAttribute("data-hand-font",""),document.head.appendChild(t)},[]);const u=o.useMemo(()=>i.filter(t=>r[t.n]!=null).length,[r]),b=o.useMemo(()=>i.reduce((t,a)=>t+(r[a.n]!=null?a.marks:0),0),[r]),d=u===i.length;o.useEffect(()=>{if(!d||c)return;const t=setTimeout(()=>{h(!0);const a=f.current;a&&!window.matchMedia("(prefers-reduced-motion: reduce)").matches&&requestAnimationFrame(()=>{a.scrollIntoView({behavior:"smooth",block:"center"})})},520);return()=>clearTimeout(t)},[d,c]);const y=o.useCallback((t,a)=>{x(s=>s[t]===a?s:{...s,[t]:a})},[]),w=()=>{x({}),h(!1),window.scrollTo({top:0,behavior:"smooth"})},g=new Date().toLocaleDateString("en-GB",{day:"2-digit",month:"short",year:"numeric"});return e.jsxs("div",{className:"ex-root",children:[e.jsx("style",{children:M}),e.jsxs("div",{className:"ex-wrap",children:[e.jsxs("button",{onClick:m,className:"ex-back",children:[e.jsx("span",{"aria-hidden":"true",children:"←"})," Back"]}),e.jsxs("div",{className:"ex-sheet",children:[e.jsx("div",{className:"ex-rule","aria-hidden":"true"}),e.jsxs("header",{className:"ex-head",children:[e.jsx("p",{className:"ex-uni",children:"Work Integrated Learning Programme"}),e.jsx("h1",{className:"ex-title",children:"Mid‑Semester Examination"}),e.jsx("p",{className:"ex-sub",children:"Computer Systems · four papers · one week · one full‑time job running underneath."}),e.jsxs("div",{className:"ex-meta",children:[e.jsxs("span",{children:["Papers: ",e.jsx("b",{children:"4"})]}),e.jsx("span",{className:"ex-dot","aria-hidden":"true",children:"·"}),e.jsxs("span",{children:["Max Marks: ",e.jsx("b",{children:l})]}),e.jsx("span",{className:"ex-dot","aria-hidden":"true",children:"·"}),e.jsxs("span",{children:["Pass Marks: ",e.jsx("b",{children:"irrelevant"})]})]}),e.jsxs("div",{className:"ex-roll",children:[e.jsx("span",{className:"ex-roll-label",children:"Roll No."}),e.jsx("span",{className:"ex-roll-box",children:e.jsx("span",{className:"ex-hand ex-roll-name",children:"Amrutha"})})]})]}),e.jsxs("section",{className:"ex-instr","aria-label":"Instructions to candidates",children:[e.jsx("p",{className:"ex-instr-h",children:"Instructions to the Candidate"}),e.jsxs("ol",{children:[e.jsx("li",{children:"All questions are compulsory. All answers are correct. This is not a trick."}),e.jsx("li",{children:"Answers may be written in any language — English, Telugu, SQL, or eye contact."}),e.jsx("li",{children:"Water bottles are permitted. Snacks are permitted. Self-doubt is confiscated at the door."}),e.jsx("li",{children:"Do not ask the invigilator for clarification — they have not read the syllabus either."}),e.jsx("li",{children:"Candidates may not leave in the first thirty minutes. If you finish early, sit back and let the hall wonder who you are."}),e.jsx("li",{children:"Any candidate caught underestimating herself will be asked to leave the hall."})]})]}),e.jsx("div",{className:"ex-qs",children:i.map(t=>{const a=r[t.n]!=null;return e.jsxs("section",{className:`ex-q ${a?"is-done":""}`,children:[t.paper&&e.jsx("p",{className:"ex-paper",children:t.paper}),e.jsxs("div",{className:"ex-q-head",children:[e.jsxs("span",{className:"ex-q-n",children:["Q",t.n,"."]}),e.jsx("p",{className:"ex-q-t",children:t.q.split(`
`).map((s,n)=>e.jsxs(k.Fragment,{children:[n>0&&e.jsx("br",{}),s]},n))}),e.jsxs("span",{className:"ex-q-m",children:["[",t.marks,"]"]})]}),t.code&&e.jsx("pre",{className:"ex-code",children:t.code}),e.jsx("ul",{className:"ex-opts",children:t.opts.map((s,n)=>{const p=r[t.n]===n;return e.jsx("li",{children:e.jsxs("button",{type:"button",onClick:()=>y(t.n,n),"aria-pressed":p,className:`ex-opt ${p?"is-on":""}`,children:[e.jsx("span",{className:"ex-bub","aria-hidden":"true",children:"abcd"[n]}),e.jsx("span",{className:"ex-opt-t",children:s}),p&&e.jsx("span",{className:"ex-hand ex-tick","aria-hidden":"true",children:"✓"})]})},n)})}),e.jsx("p",{className:`ex-hand ex-note ${a?"is-in":""}`,"aria-live":"polite",children:a?`${t.note}  ${t.marks}/${t.marks}`:""})]},t.n)})}),e.jsxs("div",{className:"ex-total","aria-live":"polite",children:[e.jsx("span",{className:"ex-total-l",children:"Total"}),e.jsxs("span",{className:"ex-hand ex-total-n",children:[b,e.jsxs("span",{className:"ex-total-d",children:["/",l]})]})]}),e.jsx("div",{className:"ex-result",ref:f,children:d?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:`ex-stamp ${c?"is-in":""}`,role:"img","aria-label":`Stamped: All the best, Amrutha. Mid-semester, ${g}. Result: certain.`,children:[e.jsx("span",{className:"ex-stamp-top",children:"Office of Good Wishes"}),e.jsx("strong",{className:"ex-stamp-big",children:"All the Best"}),e.jsxs("span",{className:"ex-stamp-bot",children:["Amrutha · All Four Papers · ",g]}),e.jsx("span",{className:"ex-stamp-res",children:"Result: certain"})]}),e.jsxs("div",{className:`ex-remark ${c?"is-in":""}`,children:[e.jsx("p",{className:"ex-remark-l",children:"Examiner's remarks"}),e.jsxs("p",{className:"ex-hand ex-remark-t",children:[l,"/",l," across all four papers, which was never really in doubt. Algorithms, databases, AI and the entire cloud — in one week, with a full-time job running the whole time. Go and get it over with. There's a mountain waiting on the other side."]}),e.jsx("p",{className:"ex-hand ex-sign",children:"— K"})]}),e.jsxs("button",{onClick:w,className:"ex-reset",children:["Attempt again (you'll still get ",l,")"]})]}):e.jsxs("p",{className:"ex-await",children:[u," of ",i.length," attempted — the examiner is waiting with the stamp ready."]})})]}),e.jsx("p",{className:"ex-foot",children:"No actual examination board was consulted in the making of this page."})]})]})}const M=`
.ex-root {
  --red: ${v};
  --ink: ${j};
  --soft: ${N};
...
.ex-hand { font-family: ${z}; font-weight: 600; }
