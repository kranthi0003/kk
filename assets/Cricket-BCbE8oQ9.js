import{r as t,j as e,R as T}from"./index-DK83Z0jw.js";const w=[{key:"test",label:"Test"},{key:"odi",label:"ODI"},{key:"t20i",label:"T20I"}],p="India",u=s=>new Date(`${s}T00:00:00Z`).toLocaleDateString("en-GB",{day:"numeric",month:"short",timeZone:"UTC"}),E=s=>Math.ceil((new Date(`${s}T00:00:00Z`).getTime()-Date.now())/864e5);function j({children:s,className:r="",delay:i=0}){const n=T.useRef(null),[l,m]=t.useState(!1);return t.useEffect(()=>{const h=n.current;if(!h)return;const x=new IntersectionObserver(([g])=>{g.isIntersecting&&(m(!0),x.disconnect())},{threshold:.1,rootMargin:"0px 0px -6% 0px"});return x.observe(h),()=>x.disconnect()},[]),e.jsx("div",{ref:n,className:`ck-reveal${l?" ck-in":""} ${r}`,style:{transitionDelay:`${i}ms`},children:s})}const I=()=>e.jsx("div",{className:"ck-seam","aria-hidden":"true"}),k=({children:s,id:r})=>e.jsx("section",{id:r,className:"max-w-3xl mx-auto px-5 sm:px-6 py-7 sm:py-9",children:s}),y=({children:s,note:r})=>e.jsxs("div",{className:"flex items-baseline justify-between gap-4 mb-5",children:[e.jsxs("h2",{className:"ck-h2",children:[e.jsx("span",{className:"ck-tick","aria-hidden":"true"}),s]}),r&&e.jsx("span",{className:"ck-note shrink-0",children:r})]});function D({formats:s,compact:r}){const i=w.filter(n=>s==null?void 0:s[n.key]);return i.length?e.jsx("div",{className:`ck-formats${r?" ck-formats-sm":""}`,children:i.map(n=>{const l=s[n.key];return e.jsxs("span",{className:"ck-fmt",children:[e.jsx("span",{className:"ck-fmt-k",children:n.label}),e.jsx("span",{className:"ck-fmt-v",children:l.result||`${l.matches} to play`})]},n.key)})}):null}function S({tour:s,featured:r}){const i=E(s.start),n=s.status==="live"?"On now":i<=0?"Under way":i===1?"Starts tomorrow":`Starts in ${i} days`;return e.jsxs("div",{className:`ck-tour${r?" ck-tour-big":""}`,children:[e.jsxs("div",{className:"ck-tour-top",children:[e.jsxs("span",{className:`ck-tag${s.status==="live"?" ck-tag-live":""}`,children:[s.status==="live"&&e.jsx("span",{className:"ck-pip","aria-hidden":"true"}),n]}),e.jsxs("span",{className:"ck-note",children:[u(s.start)," – ",u(s.ends)]})]}),e.jsxs("h3",{className:"ck-tour-name",children:[e.jsx("span",{className:s.away==="IND"?"ck-me":"",children:s.awayName}),e.jsx("span",{className:"ck-vs",children:"in"}),e.jsx("span",{className:s.home==="IND"?"ck-me":"",children:s.homeName})]}),e.jsx(D,{formats:s.formats,compact:!r})]})}function R({rows:s}){var i;const r=((i=s==null?void 0:s[0])==null?void 0:i.rating)||1;return e.jsx("div",{className:"ck-rank",children:(s||[]).map(n=>{const l=n.team===p;return e.jsxs("div",{className:`ck-row${l?" ck-row-me":""}`,children:[e.jsx("span",{className:"ck-bar",style:{width:`${Math.max(4,n.rating/r*100)}%`},"aria-hidden":"true"}),e.jsx("span",{className:"ck-pos",children:n.pos}),e.jsxs("span",{className:"min-w-0 flex-1 relative",children:[e.jsx("span",{className:"block text-[14.5px] font-medium leading-tight truncate",children:n.team}),e.jsxs("span",{className:"ck-sub block truncate",children:[n.matches," matches"]})]}),e.jsx("span",{className:"ck-rating",children:n.rating})]},n.code+n.pos)})})}function F({m:s}){const r=s.winner?`${s.winner} won by ${s.margin}`:s.margin||"No result";return e.jsxs("div",{className:"ck-res",children:[e.jsxs("div",{className:"ck-res-head",children:[e.jsxs("span",{className:"ck-res-teams",children:[e.jsx("span",{className:s.teams[0]===p?"ck-me":"",children:s.teams[0]}),e.jsx("span",{className:"ck-vs",children:"v"}),e.jsx("span",{className:s.teams[1]===p?"ck-me":"",children:s.teams[1]})]}),e.jsxs("span",{className:"ck-note shrink-0",children:[s.type,s.gender==="female"?" W":""," · ",u(s.date)]})]}),e.jsx("div",{className:"ck-res-line",children:r}),(s.event||s.city)&&e.jsx("div",{className:"ck-sub truncate",children:[s.event,s.city].filter(Boolean).join(" · ")})]})}function A({onBack:s}){var C;const[r,i]=t.useState(void 0),[n,l]=t.useState("odi"),[m,h]=t.useState(null),[x,g]=t.useState(!1);t.useEffect(()=>{let a=!0;return fetch("/cricket.json").then(c=>c.ok?c.json():Promise.reject(new Error(String(c.status)))).then(c=>a&&i(c)).catch(()=>a&&i(null)),()=>{a=!1}},[]),t.useEffect(()=>{if(!r||m)return;const a=(r.recent||[]).some(c=>c.teams.includes(p));h(a?"india":"intl")},[r,m]);const M=t.useMemo(()=>r?w.map(a=>{var c;return{...a,row:(((c=r.rankings)==null?void 0:c[a.key])||[]).find(d=>d.team===p)||null}}):[],[r]),o=t.useMemo(()=>((r==null?void 0:r.tours)||[]).filter(a=>a.status==="live"),[r]),b=t.useMemo(()=>((r==null?void 0:r.tours)||[]).filter(a=>a.status==="upcoming"),[r]),z=t.useMemo(()=>((r==null?void 0:r.tours)||[]).filter(a=>a.status==="done").reverse(),[r]),v=t.useMemo(()=>{const a=o.length?o:b;return a.find(c=>c.home==="IND"||c.away==="IND")||a[0]||null},[o,b]),$=t.useMemo(()=>(o.length?o:b).filter(a=>a!==v),[o,b,v]),f=t.useMemo(()=>{const a=(r==null?void 0:r.recent)||[];return m==="all"?a:m==="intl"?a.filter(c=>c.international):a.filter(c=>c.teams.includes(p))},[r,m]),N=x?f:f.slice(0,8);return e.jsxs("div",{className:"ck-root",children:[e.jsxs("button",{onClick:s,title:"Back",className:"ck-back",children:[e.jsx("svg",{className:"w-4 h-4",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:2.2,children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M15 19l-7-7 7-7"})}),e.jsx("span",{className:"hidden sm:inline",children:"Back"})]}),e.jsx("header",{className:"ck-hero",children:e.jsxs("div",{className:"max-w-3xl mx-auto px-5 sm:px-6",children:[e.jsx("h1",{className:"ck-h1",children:"Cricket"}),e.jsx("p",{className:"ck-lede",children:"Where India stand, what’s being played, and how the last few weeks finished."}),r&&e.jsx("div",{className:"ck-mine",children:M.map(({key:a,label:c,row:d})=>e.jsxs("div",{className:"ck-mine-cell",children:[e.jsx("span",{className:"ck-mine-fmt",children:c}),d?e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"ck-mine-pos",children:[e.jsx("b",{children:d.pos}),e.jsx("i",{children:d.pos===1?"st":d.pos===2?"nd":d.pos===3?"rd":"th"})]}),e.jsxs("span",{className:"ck-mine-rat",children:[d.rating," pts"]})]}):e.jsx("span",{className:"ck-mine-rat",children:"—"})]},a))})]})}),e.jsx(I,{}),r===void 0&&e.jsx(k,{children:e.jsx("div",{className:"ck-state",children:"Taking guard…"})}),r===null&&e.jsx(k,{children:e.jsx("div",{className:"ck-state",children:"Couldn’t load the cricket right now."})}),r&&e.jsxs(e.Fragment,{children:[v&&e.jsx(k,{children:e.jsxs(j,{children:[e.jsx(y,{note:o.length?`${o.length} on`:"next",children:o.length?"Out in the middle":"Next up"}),e.jsx(S,{tour:v,featured:!0}),$.length>0&&e.jsx("div",{className:"ck-tour-grid",children:$.slice(0,4).map(a=>e.jsx(S,{tour:a},a.name+a.start))})]})}),e.jsx(k,{children:e.jsxs(j,{children:[e.jsx(y,{note:"ICC ratings",children:"Rankings"}),e.jsx("div",{className:"ck-tabs",role:"tablist",children:w.map(a=>e.jsx("button",{role:"tab","aria-selected":n===a.key,onClick:()=>l(a.key),className:`ck-tab${n===a.key?" ck-tab-on":""}`,children:a.label},a.key))}),e.jsx(R,{rows:(C=r.rankings)==null?void 0:C[n]})]})}),e.jsx(k,{children:e.jsxs(j,{children:[e.jsx(y,{note:`${f.length} matches`,children:"Recently played"}),e.jsx("div",{className:"ck-switch",children:[{k:"india",label:"India"},{k:"intl",label:"Internationals"},{k:"all",label:"Everything"}].map(a=>e.jsx("button",{onClick:()=>{h(a.k),g(!1)},className:`ck-chip${m===a.k?" ck-chip-on":""}`,children:a.label},a.k))}),e.jsx("div",{className:"ck-res-list",children:N.map((a,c)=>e.jsx(F,{m:a},`${a.date}-${a.teams.join("-")}-${c}`))}),f.length>N.length&&e.jsxs("button",{onClick:()=>g(!0),className:"ck-more",children:["Show ",f.length-N.length," more"]})]})}),z.length>0&&e.jsx(k,{children:e.jsxs(j,{children:[e.jsx(y,{note:`${r.season} season`,children:"Tours already done"}),e.jsx("div",{className:"ck-past",children:z.map(a=>e.jsxs("div",{className:"ck-past-row",children:[e.jsx("span",{className:"ck-past-date",children:u(a.start)}),e.jsxs("span",{className:"min-w-0 flex-1",children:[e.jsxs("span",{className:"block text-[13.5px] truncate",children:[e.jsx("span",{className:a.away==="IND"?"ck-me":"",children:a.awayName})," ","in"," ",e.jsx("span",{className:a.home==="IND"?"ck-me":"",children:a.homeName})]}),e.jsx(D,{formats:a.formats,compact:!0})]})]},a.name+a.start))})]})}),e.jsx(I,{}),e.jsx(k,{children:e.jsxs("div",{className:"ck-foot",children:[e.jsx("p",{children:"Rankings and the tour calendar come from Wikipedia; results come from Cricsheet’s ball-by-ball archive. Built with the site, not fetched live — so the numbers are current as of the last deploy."}),e.jsx("p",{className:"ck-foot-links",children:(r.sources||[]).map(a=>e.jsx("a",{href:a.url,target:"_blank",rel:"noreferrer",children:a.name},a.url))}),r.generated&&e.jsxs("p",{className:"ck-note",children:["Updated ",u(r.generated.slice(0,10))]})]})})]}),e.jsx("style",{children:`
        .ck-root {
          --ck-bg: #07110C;
          --ck-card: #0E1A13;
          --ck-line: #1D3327;
