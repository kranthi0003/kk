import{r as n,j as e,W as N}from"./index-_LrZxD_x.js";const z="#C0392B",A="#2E2A26",S="#6A625B",B="#FBF7EE",M="https://fonts.googleapis.com/css2?family=Caveat:wght@500;600;700&display=swap",E="'Caveat', 'Segoe Script', 'Bradley Hand', cursive",l=[{n:1,marks:20,paper:"Paper I — Data Structures & Algorithms",q:"Determine the time complexity of the candidate’s preparation.",opts:["O(1) — constant, and unbothered","O(log n) — she halves the syllabus every sitting","O(n), but she will optimise it tonight","Irrelevant. It terminates, and it returns correct."],note:"Correct. Optimal."},{n:2,marks:20,paper:"Paper II — Database Systems",kind:"sql",q:"The following query is executed against the mid-semester schema. State the output.",code:`SELECT subject
  FROM midsem
 WHERE difficulty > amrutha.capability;`,opts:["Empty set (0.00 sec)","0 rows returned","NULL","All of the above, which are the same thing, which is the point"],note:"Correct. No rows, as expected."},{n:3,marks:15,paper:"Paper III — AI Systems",kind:"ar",q:`Assertion (A): The model has converged. Training should stop.
Reason (R): She has been running this alongside a full-time job for months, and the loss is as low as loss goes.`,opts:["Both A and R are true, and R is the correct explanation of A","Both A and R are true, obviously","Both A and R are true; further epochs risk overfitting","Both A and R are true. Deploy her."],note:"Correct. Full marks."},{n:4,marks:15,paper:"Paper IV — Cloud Computing",q:"The candidate’s uptime through exam week is best described as:",opts:["Highly available","Fault tolerant, multi-region","Auto-scaling under load","Five nines, with one planned outage for sleep"],note:"Correct. Well provisioned."},{n:5,marks:15,paper:"Section E — Descriptive",kind:"text",q:"Define, in one line, the entire syllabus across all four papers.",placeholder:"write anything at all…",note:"Correct. Beautifully put."},{n:6,marks:15,paper:"Bonus — Post-Deployment",q:"On successful completion of the above, the candidate is to be deployed to:",opts:["Somewhere with mountains","Somewhere with trees","Somewhere with no network, deliberately","All of the above, in that order"],note:"Correct. Booked, practically."}],c=l.reduce((p,s)=>p+s.marks,0);function R({onBack:p}){const[s,f]=n.useState({}),[i,g]=n.useState(""),[d,u]=n.useState(!1),b=n.useRef(null);n.useEffect(()=>{if(document.querySelector("link[data-hand-font]"))return;const t=document.createElement("link");t.rel="stylesheet",t.href=M,t.setAttribute("data-hand-font",""),document.head.appendChild(t)},[]);const y=n.useMemo(()=>l.filter(a=>a.kind!=="text"&&s[a.n]!=null).length+(i.trim()?1:0),[s,i]),j=n.useMemo(()=>l.reduce((t,a)=>{const r=a.kind==="text"?i.trim().length>0:s[a.n]!=null;return t+(r?a.marks:0)},0),[s,i]),x=y===l.length;n.useEffect(()=>{if(!x||d)return;const t=setTimeout(()=>{u(!0);const a=b.current;a&&!window.matchMedia("(prefers-reduced-motion: reduce)").matches&&requestAnimationFrame(()=>{a.scrollIntoView({behavior:"smooth",block:"center"})})},520);return()=>clearTimeout(t)},[x,d]);const k=n.useCallback((t,a)=>{f(r=>r[t]===a?r:{...r,[t]:a})},[]),v=()=>{f({}),g(""),u(!1),window.scrollTo({top:0,behavior:"smooth"})},w=new Date().toLocaleDateString("en-GB",{day:"2-digit",month:"short",year:"numeric"});return e.jsxs("div",{className:"ex-root",children:[e.jsx("style",{children:C}),e.jsxs("div",{className:"ex-wrap",children:[e.jsxs("button",{onClick:p,className:"ex-back",children:[e.jsx("span",{"aria-hidden":"true",children:"←"})," Back"]}),e.jsxs("div",{className:"ex-sheet",children:[e.jsx("div",{className:"ex-rule","aria-hidden":"true"}),e.jsxs("header",{className:"ex-head",children:[e.jsx("p",{className:"ex-uni",children:"Work Integrated Learning Programme"}),e.jsx("h1",{className:"ex-title",children:"Mid‑Semester Examination"}),e.jsx("p",{className:"ex-sub",children:"Computer Systems · four papers · one week · one full‑time job running underneath."}),e.jsxs("div",{className:"ex-meta",children:[e.jsxs("span",{children:["Papers: ",e.jsx("b",{children:"4"})]}),e.jsx("span",{className:"ex-dot","aria-hidden":"true",children:"·"}),e.jsxs("span",{children:["Max Marks: ",e.jsx("b",{children:c})]}),e.jsx("span",{className:"ex-dot","aria-hidden":"true",children:"·"}),e.jsxs("span",{children:["Pass Marks: ",e.jsx("b",{children:"irrelevant"})]})]}),e.jsxs("div",{className:"ex-roll",children:[e.jsx("span",{className:"ex-roll-label",children:"Roll No."}),e.jsx("span",{className:"ex-roll-box",children:e.jsx("span",{className:"ex-hand ex-roll-name",children:"Amrutha"})})]})]}),e.jsxs("section",{className:"ex-instr","aria-label":"Instructions to candidates",children:[e.jsx("p",{className:"ex-instr-h",children:"Instructions to the Candidate"}),e.jsxs("ol",{children:[e.jsx("li",{children:"All questions are compulsory. All answers are correct."}),e.jsx("li",{children:"Four papers in one week. This has been survived before, with less notice."}),e.jsx("li",{children:"Answers may be written in any language, including SQL."}),e.jsx("li",{children:"Use of a calculator is permitted. Use of panic is not."}),e.jsx("li",{children:"Do not write in the margin — the margin is writing back."})]})]}),e.jsx("div",{className:"ex-qs",children:l.map(t=>{const a=t.kind==="text",r=a?i.trim().length>0:s[t.n]!=null;return e.jsxs("section",{className:`ex-q ${r?"is-done":""}`,children:[t.paper&&e.jsx("p",{className:"ex-paper",children:t.paper}),e.jsxs("div",{className:"ex-q-head",children:[e.jsxs("span",{className:"ex-q-n",children:["Q",t.n,"."]}),e.jsx("p",{className:"ex-q-t",children:t.q.split(`
`).map((m,o)=>e.jsxs(N.Fragment,{children:[o>0&&e.jsx("br",{}),m]},o))}),e.jsxs("span",{className:"ex-q-m",children:["[",t.marks,"]"]})]}),t.code&&e.jsx("pre",{className:"ex-code",children:t.code}),a?e.jsxs("div",{className:"ex-lines",children:[e.jsx("input",{type:"text",value:i,onChange:m=>g(m.target.value),placeholder:t.placeholder,className:"ex-hand ex-input","aria-label":t.q,maxLength:90}),e.jsx("span",{className:"ex-line","aria-hidden":"true"}),e.jsx("span",{className:"ex-line","aria-hidden":"true"})]}):e.jsx("ul",{className:"ex-opts",children:t.opts.map((m,o)=>{const h=s[t.n]===o;return e.jsx("li",{children:e.jsxs("button",{type:"button",onClick:()=>k(t.n,o),"aria-pressed":h,className:`ex-opt ${h?"is-on":""}`,children:[e.jsx("span",{className:"ex-bub","aria-hidden":"true",children:"abcd"[o]}),e.jsx("span",{className:"ex-opt-t",children:m}),h&&e.jsx("span",{className:"ex-hand ex-tick","aria-hidden":"true",children:"✓"})]})},o)})}),e.jsx("p",{className:`ex-hand ex-note ${r?"is-in":""}`,"aria-live":"polite",children:r?`${t.note}  ${t.marks}/${t.marks}`:""})]},t.n)})}),e.jsxs("div",{className:"ex-total","aria-live":"polite",children:[e.jsx("span",{className:"ex-total-l",children:"Total"}),e.jsxs("span",{className:"ex-hand ex-total-n",children:[j,e.jsxs("span",{className:"ex-total-d",children:["/",c]})]})]}),e.jsx("div",{className:"ex-result",ref:b,children:x?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:`ex-stamp ${d?"is-in":""}`,role:"img","aria-label":`Stamped: All the best, Amrutha. Mid-semester, ${w}. Result: certain.`,children:[e.jsx("span",{className:"ex-stamp-top",children:"Office of Good Wishes"}),e.jsx("strong",{className:"ex-stamp-big",children:"All the Best"}),e.jsxs("span",{className:"ex-stamp-bot",children:["Amrutha · All Four Papers · ",w]}),e.jsx("span",{className:"ex-stamp-res",children:"Result: certain"})]}),e.jsxs("div",{className:`ex-remark ${d?"is-in":""}`,children:[e.jsx("p",{className:"ex-remark-l",children:"Examiner's remarks"}),e.jsxs("p",{className:"ex-hand ex-remark-t",children:[c,"/",c," across all four papers, which was never really in doubt. Algorithms, databases, AI and the entire cloud — in one week, with a full-time job running the whole time. Go and get it over with. There's a mountain waiting on the other side."]}),e.jsx("p",{className:"ex-hand ex-sign",children:"— K"})]}),e.jsxs("button",{onClick:v,className:"ex-reset",children:["Attempt again (you'll still get ",c,")"]})]}):e.jsxs("p",{className:"ex-await",children:[y," of ",l.length," attempted — the examiner is waiting with the stamp ready."]})})]}),e.jsx("p",{className:"ex-foot",children:"No actual examination board was consulted in the making of this page."})]})]})}const C=`
.ex-root {
  --red: ${z};
  --ink: ${A};
  --soft: ${S};
...
.ex-hand { font-family: ${E}; font-weight: 600; }
