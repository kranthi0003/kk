import{r as n,j as e}from"./index-BO8BhecR.js";const ae={mercedes:"#00D7B6",ferrari:"#E8002D",mclaren:"#FF8000",red_bull:"#3671C6",rb:"#6692FF",alpine:"#00A1E8",haas:"#B6BABD",audi:"#BB0A30",williams:"#64C4FF",aston_martin:"#229971",cadillac:"#C6A664"},j=a=>ae[a]||"#8A8A96",K="https://api.jolpi.ca/ergast/f1",ie=6.5,oe=9e3,E=a=>String(a).padStart(2,"0"),R=a=>new Date(a).toLocaleDateString("en-GB",{day:"numeric",month:"short"}),le=a=>new Date(a).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"});function x({children:a,className:r="",delay:u=0}){const h=n.useRef(null),[f,l]=n.useState(!1);return n.useEffect(()=>{const N=h.current;if(!N)return;const w=new IntersectionObserver(([S])=>{S.isIntersecting&&(l(!0),w.disconnect())},{threshold:.1,rootMargin:"0px 0px -6% 0px"});return w.observe(N),()=>w.disconnect()},[]),e.jsx("div",{ref:h,className:r,style:{opacity:f?1:0,transform:f?"translateY(0)":"translateY(-26px)",transition:`opacity .8s cubic-bezier(.22,.61,.36,1) ${u}s, transform .8s cubic-bezier(.22,.61,.36,1) ${u}s`},children:a})}function ce(a){const r=n.useMemo(()=>a?new Date(a).getTime():null,[a]),[u,h]=n.useState(()=>Date.now());if(n.useEffect(()=>{if(!r||r-Date.now()<=0)return;const l=setInterval(()=>h(Date.now()),1e3);return()=>clearInterval(l)},[r]),!r)return null;const f=r-u;return f<=0?{past:!0,d:0,h:0,m:0,s:0}:{past:!1,d:Math.floor(f/864e5),h:Math.floor(f/36e5%24),m:Math.floor(f/6e4%60),s:Math.floor(f/1e3%60)}}const T=()=>e.jsx("div",{className:"f1-kerb","aria-hidden":"true"}),m=({children:a,id:r})=>e.jsx("section",{id:r,className:"max-w-3xl mx-auto px-5 sm:px-6 py-7 sm:py-9",children:a}),k=({children:a,note:r})=>e.jsxs("div",{className:"flex items-baseline justify-between gap-4 mb-5",children:[e.jsxs("h2",{className:"f1-h2",children:[e.jsx("span",{className:"f1-tick","aria-hidden":"true"}),a]}),r&&e.jsx("span",{className:"f1-note shrink-0",children:r})]});function B({pos:a,color:r,name:u,sub:h,points:f,wins:l,pct:N,lead:w}){return e.jsxs("div",{className:`f1-row${w?" f1-row-lead":""}`,children:[e.jsx("span",{className:"f1-bar",style:{width:`${N}%`,background:r},"aria-hidden":"true"}),e.jsx("span",{className:"f1-pos",children:a}),e.jsx("span",{className:"f1-stripe",style:{background:r},"aria-hidden":"true"}),e.jsxs("span",{className:"min-w-0 flex-1 relative",children:[e.jsx("span",{className:"block text-[14.5px] font-medium leading-tight truncate",children:u}),h&&e.jsx("span",{className:"f1-sub block truncate",children:h})]}),l>0&&e.jsxs("span",{className:"f1-wins",children:[l,"W"]}),e.jsx("span",{className:"f1-pts",children:f})]})}function fe({onBack:a}){var G,H,V,Y,U;const[r,u]=n.useState(void 0),[h,f]=n.useState(!1),[l,N]=n.useState("film"),[w,S]=n.useState(!1),[Q,Z]=n.useState(!1),[D,L]=n.useState(!1),[$,I]=n.useState(!1),[F,A]=n.useState(!1),[C,ee]=n.useState(!1),v=n.useRef(null),g=n.useCallback(()=>{N(s=>{if(s==="open")return s;const t=v.current;return t&&(t.loop=!0,t.ended&&(t.currentTime=0,t.play().catch(()=>{}))),"open"}),S(!0)},[]);n.useEffect(()=>{const s=window.matchMedia("(prefers-reduced-motion: reduce)"),t=i=>{ee(i),i&&g()};t(s.matches);const c=i=>t(i.matches);return s.addEventListener("change",c),()=>s.removeEventListener("change",c)},[g]),n.useEffect(()=>{let s=!0;return fetch("/f1.json").then(t=>t.ok?t.json():Promise.reject(new Error(String(t.status)))).then(t=>s&&u(t)).catch(()=>s&&u(null)),()=>{s=!1}},[]),n.useEffect(()=>{if(!(r!=null&&r.season))return;let s=!0;return Promise.all([fetch(`${K}/${r.season}/driverstandings/?format=json`).then(t=>t.json()),fetch(`${K}/${r.season}/constructorstandings/?format=json`).then(t=>t.json())]).then(([t,c])=>{var M;if(!s)return;const i=t.MRData.StandingsTable.StandingsLists[0],z=c.MRData.StandingsTable.StandingsLists[0];(M=i==null?void 0:i.DriverStandings)!=null&&M.length&&(u(X=>({...X,round:Number(i.round)||X.round,drivers:i.DriverStandings.map(o=>{var q,J;return{pos:Number(o.position),points:Number(o.points),wins:Number(o.wins),code:o.Driver.code||o.Driver.familyName.slice(0,3).toUpperCase(),first:o.Driver.givenName,last:o.Driver.familyName,team:((q=o.Constructors[o.Constructors.length-1])==null?void 0:q.name)||"",teamId:((J=o.Constructors[o.Constructors.length-1])==null?void 0:J.constructorId)||""}}),constructors:((z==null?void 0:z.ConstructorStandings)||[]).map(o=>({pos:Number(o.position),points:Number(o.points),wins:Number(o.wins),name:o.Constructor.name,teamId:o.Constructor.constructorId}))})),f(!0))}).catch(()=>{}),()=>{s=!1}},[r==null?void 0:r.season]),n.useEffect(()=>{const s=v.current;!s||C||(s.volume=1,s.muted=!1,s.play().then(()=>L(!1)).catch(()=>{s.muted=!0,L(!0),I(!0),s.play().catch(()=>g())}))},[C,g]),n.useEffect(()=>{if(!$)return;const s=()=>{const t=v.current;t&&(t.muted=!1,t.volume=1,t.play().catch(()=>{}),L(!1)),I(!1)};return window.addEventListener("pointerdown",s,{once:!0}),window.addEventListener("keydown",s,{once:!0}),()=>{window.removeEventListener("pointerdown",s),window.removeEventListener("keydown",s)}},[$]),n.useEffect(()=>{if(l!=="film")return;const s=document.body.style.overflow;return document.body.style.overflow="hidden",window.scrollTo(0,0),()=>{document.body.style.overflow=s}},[l]),n.useEffect(()=>{if(l!=="film")return;const s=setTimeout(()=>Z(!0),3500),t=setTimeout(()=>{const c=v.current;(!c||c.paused||c.currentTime===0)&&g()},oe);return()=>{clearTimeout(s),clearTimeout(t)}},[l,g]);const se=n.useCallback(()=>{const s=v.current;!(s!=null&&s.duration)||Number.isNaN(s.duration)||s.currentTime>=s.duration-ie&&S(!0)},[]),P=n.useCallback(()=>{const s=v.current;s&&(s.muted=!s.muted,s.muted||(s.volume=1),L(s.muted),I(!1),s.paused&&s.play().catch(()=>{}))},[]),re=n.useCallback(()=>{const s=v.current;s&&(s.paused?s.play().catch(()=>{}):s.pause())},[]),d=n.useMemo(()=>{if(!(r!=null&&r.races))return null;const s=Date.now();return r.races.find(t=>new Date(t.start).getTime()>s)||null},[r]),b=ce(d==null?void 0:d.start),y=n.useMemo(()=>((r==null?void 0:r.races)||[]).filter(s=>new Date(s.start).getTime()<Date.now()),[r]),W=n.useMemo(()=>{if(!(r!=null&&r.drivers))return[];const s=new Map;for(const t of r.drivers)t.teamId&&(s.has(t.teamId)||s.set(t.teamId,[]),s.get(t.teamId).push(t));return[...s.entries()].map(([t,c])=>{const i=[...c].sort((z,M)=>M.points-z.points).slice(0,2);return i.length===2?{teamId:t,team:i[0].team,a:i[0],b:i[1],total:i[0].points+i[1].points}:null}).filter(Boolean).sort((t,c)=>c.total-t.total)},[r]),p=((G=r==null?void 0:r.drivers)==null?void 0:G.length)>=2?{p1:r.drivers[0],p2:r.drivers[1]}:null,O=r!=null&&r.races?r.races.length-y.length:0,te=((V=(H=r==null?void 0:r.drivers)==null?void 0:H[0])==null?void 0:V.points)||1,ne=((U=(Y=r==null?void 0:r.constructors)==null?void 0:Y[0])==null?void 0:U.points)||1,_="/";return e.jsxs("div",{className:"f1-root",children:[e.jsxs("button",{onClick:a,title:"Back",className:"f1-back",children:[e.jsx("svg",{className:"w-4 h-4",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:2.2,children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M15 19l-7-7 7-7"})}),e.jsx("span",{className:"hidden sm:inline",children:"Back"})]}),e.jsxs("div",{className:"f1-hero",children:[e.jsx("video",{ref:v,className:"f1-video",src:`${_}f1/hero.mp4`,poster:`${_}f1/poster.jpg`,playsInline:!0,preload:"auto",autoPlay:!C,onTimeUpdate:se,onEnded:g,onError:g,onPlay:()=>A(!0),onPause:()=>A(!1)}),e.jsx("div",{className:"f1-scrim","aria-hidden":"true"}),e.jsxs("div",{className:"f1-hero-inner",children:[e.jsxs("div",{className:`f1-title${w?" f1-title-in":""}`,children:[e.jsxs("div",{className:"f1-eyebrow",children:[(r==null?void 0:r.season)||""," Season",r!=null&&r.round?` · Round ${r.round}`:""]}),e.jsxs("h1",{className:"f1-h1",children:["Formula 1",e.jsx("span",{className:"f1-h1-kerb","aria-hidden":"true"})]}),e.jsx("p",{className:"f1-lede",children:"Eight world titles, a hybrid era, and a grid that still argues about it. The championship as it stands tonight."})]}),l==="open"&&e.jsxs("button",{onClick:()=>{var s;return(s=document.getElementById("f1-details"))==null?void 0:s.scrollIntoView({behavior:C?"auto":"smooth",block:"start"})},className:"f1-cue","aria-label":"Scroll to the championship",children:[e.jsx("span",{className:"f1-cue-text",children:"The standings"}),e.jsx("svg",{className:"w-5 h-5 f1-bob",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:1.8,children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M19 14l-7 7m0 0l-7-7m7 7V3"})})]})]}),$&&l==="film"&&e.jsxs("button",{onClick:P,className:"f1-sound-prompt",children:[e.jsxs("svg",{className:"w-4 h-4",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:1.9,children:[e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M11 5L6 9H3v6h3l5 4V5z"}),e.jsx("path",{strokeLinecap:"round",d:"M15.5 8.5a5 5 0 010 7M18 6a8.5 8.5 0 010 12"})]}),"Tap for sound"]}),l==="film"&&Q&&e.jsxs("button",{onClick:g,className:"f1-skip",children:["Skip the film",e.jsx("svg",{className:"w-3.5 h-3.5",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:2,children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M13 5l7 7-7 7M5 5l7 7-7 7"})})]}),e.jsxs("div",{className:"f1-controls",children:[e.jsx("button",{onClick:re,className:"f1-ctl","aria-label":F?"Pause the film":"Play the film",children:F?e.jsxs("svg",{className:"w-4 h-4",viewBox:"0 0 24 24",fill:"currentColor",children:[e.jsx("rect",{x:"6",y:"5",width:"4",height:"14",rx:"1"}),e.jsx("rect",{x:"14",y:"5",width:"4",height:"14",rx:"1"})]}):e.jsx("svg",{className:"w-4 h-4",viewBox:"0 0 24 24",fill:"currentColor",children:e.jsx("path",{d:"M8 5.5v13l11-6.5z"})})}),e.jsx("button",{onClick:P,className:`f1-ctl${D?"":" f1-ctl-on"}`,"aria-label":D?"Unmute the film":"Mute the film",children:D?e.jsxs("svg",{className:"w-4 h-4",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:1.9,children:[e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M11 5L6 9H3v6h3l5 4V5z"}),e.jsx("path",{strokeLinecap:"round",d:"M17 9l4 6m0-6l-4 6"})]}):e.jsxs("svg",{className:"w-4 h-4",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:1.9,children:[e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M11 5L6 9H3v6h3l5 4V5z"}),e.jsx("path",{strokeLinecap:"round",d:"M15.5 8.5a5 5 0 010 7M18 6a8.5 8.5 0 010 12"})]})})]})]}),l==="open"&&e.jsxs("div",{id:"f1-details",className:"f1-details",children:[e.jsx(T,{}),r===void 0&&e.jsx(m,{children:e.jsx("div",{className:"f1-state",children:"Warming the tyres…"})}),r===null&&e.jsx(m,{children:e.jsx("div",{className:"f1-state",children:"Couldn’t load the championship right now."})}),r&&e.jsxs(e.Fragment,{children:[e.jsx(m,{children:e.jsx(x,{children:e.jsxs("div",{className:"f1-pulse",children:[e.jsxs("div",{className:"f1-pulse-head",children:[e.jsxs("span",{className:"f1-pulse-round",children:["Round ",e.jsx("b",{children:y.length})," of ",r.races.length]}),e.jsxs("span",{className:"f1-note",children:[O," to go"]})]}),e.jsx("div",{className:"f1-track",role:"img","aria-label":`${y.length} of ${r.races.length} rounds complete`,children:e.jsx("span",{className:"f1-track-fill",style:{width:`${y.length/r.races.length*100}%`}})}),e.jsxs("div",{className:"f1-pulse-grid",children:[e.jsxs("div",{children:[e.jsx("b",{children:r.drivers.reduce((s,t)=>s+t.wins,0)}),e.jsx("span",{children:"races won"})]}),e.jsxs("div",{children:[e.jsx("b",{children:new Set(y.map(s=>{var t;return(t=s.winner)==null?void 0:t.last}).filter(Boolean)).size}),e.jsx("span",{children:"winners"})]}),e.jsxs("div",{children:[e.jsx("b",{children:new Set(r.races.map(s=>s.country)).size}),e.jsx("span",{children:"countries"})]}),e.jsxs("div",{children:[e.jsx("b",{children:r.constructors.length}),e.jsx("span",{children:"teams"})]})]})]})})}),d&&e.jsx(m,{children:e.jsx(x,{children:e.jsxs("div",{className:"f1-next",children:[e.jsxs("div",{className:"f1-next-tag",children:["Next up · Round ",d.round]}),e.jsx("h2",{className:"f1-next-name",children:d.name}),e.jsxs("p",{className:"f1-next-where",children:[d.circuit," · ",d.locality,", ",d.country,e.jsx("span",{className:"f1-dot",children:"·"}),R(d.start),", ",le(d.start)]}),b&&!b.past&&e.jsx("div",{className:"f1-clock",children:[["Days",b.d],["Hrs",E(b.h)],["Min",E(b.m)],["Sec",E(b.s)]].map(([s,t])=>e.jsxs("div",{className:"f1-clock-cell",children:[e.jsx("div",{className:"f1-clock-num",children:t}),e.jsx("div",{className:"f1-clock-lab",children:s})]},s))}),(b==null?void 0:b.past)&&e.jsx("p",{className:"f1-sub",children:"Lights out."})]})})}),p&&e.jsx(m,{children:e.jsxs(x,{children:[e.jsx(k,{note:`${O} rounds left`,children:"The title race"}),e.jsxs("div",{className:"f1-duel",children:[e.jsxs("div",{className:"f1-duel-side",children:[e.jsx("span",{className:"f1-duel-pos",children:"P1"}),e.jsx("span",{className:"f1-duel-name",style:{color:j(p.p1.teamId)},children:p.p1.last}),e.jsx("span",{className:"f1-duel-pts",children:p.p1.points}),e.jsx("span",{className:"f1-sub",children:p.p1.team})]}),e.jsxs("div",{className:"f1-duel-gap",children:[e.jsx("b",{children:p.p1.points-p.p2.points}),e.jsx("span",{children:"points"})]}),e.jsxs("div",{className:"f1-duel-side",children:[e.jsx("span",{className:"f1-duel-pos",children:"P2"}),e.jsx("span",{className:"f1-duel-name",style:{color:j(p.p2.teamId)},children:p.p2.last}),e.jsx("span",{className:"f1-duel-pts",children:p.p2.points}),e.jsx("span",{className:"f1-sub",children:p.p2.team})]})]})]})}),e.jsx(T,{}),e.jsx(m,{children:e.jsxs(x,{children:[e.jsx(k,{note:h?"live":`after round ${r.round}`,children:"Drivers"}),e.jsx("div",{className:"space-y-1",children:r.drivers.map(s=>e.jsx(B,{pos:s.pos,color:j(s.teamId),name:`${s.first} ${s.last}`,sub:s.team,points:s.points,wins:s.wins,pct:s.points/te*100,lead:s.pos===1},`${s.code}-${s.pos}`))})]})}),e.jsx(m,{children:e.jsxs(x,{children:[e.jsx(k,{note:`${r.constructors.length} teams`,children:"Constructors"}),e.jsx("div",{className:"space-y-1",children:r.constructors.map(s=>e.jsx(B,{pos:s.pos,color:j(s.teamId),name:s.name,points:s.points,wins:s.wins,pct:s.points/ne*100,lead:s.pos===1},s.teamId))})]})}),W.length>0&&e.jsx(m,{children:e.jsxs(x,{children:[e.jsx(k,{note:"points split",children:"Teammates"}),e.jsx("div",{className:"space-y-2.5",children:W.map(s=>{const t=s.total>0?s.a.points/s.total*100:0;return e.jsxs("div",{className:"f1-mate",children:[e.jsxs("div",{className:"f1-mate-head",children:[e.jsx("span",{className:"f1-mate-team",style:{color:j(s.teamId)},children:s.team}),e.jsxs("span",{className:"f1-note",children:[s.total," pts"]})]}),e.jsx("div",{className:"f1-mate-bar",children:e.jsx("span",{className:"f1-mate-fill",style:{width:`${t}%`,background:j(s.teamId)}})}),e.jsxs("div",{className:"f1-mate-feet",children:[e.jsxs("span",{children:[s.a.last," ",e.jsx("b",{children:s.a.points})]}),e.jsxs("span",{children:[e.jsx("b",{children:s.b.points})," ",s.b.last]})]})]},s.teamId)})})]})}),e.jsx(T,{}),y.some(s=>s.winner)&&e.jsx(m,{children:e.jsxs(x,{children:[e.jsx(k,{note:"winner · pole",children:"The season so far"}),e.jsx("div",{className:"space-y-1",children:y.filter(s=>s.winner).map(s=>e.jsxs("div",{className:"f1-past",children:[e.jsx("span",{className:"f1-pos",children:s.round}),e.jsxs("span",{className:"min-w-0 flex-1",children:[e.jsx("span",{className:"block text-[14px] leading-tight truncate",children:s.name}),e.jsxs("span",{className:"f1-sub block truncate",children:[e.jsx("b",{style:{color:j(s.winner.teamId)},children:s.winner.last}),e.jsx("span",{className:"f1-dot",children:"·"}),s.winner.team]})]}),s.pole&&e.jsxs("span",{className:"f1-pole",title:`Pole: ${s.pole.last} ${s.pole.time}`,children:[e.jsx("span",{className:"f1-pole-tag",children:"P"}),s.pole.last]})]},s.round))})]})}),r.lastRace&&e.jsx(m,{children:e.jsxs(x,{children:[e.jsx(k,{note:R(r.lastRace.date),children:"Last time out"}),e.jsxs("p",{className:"f1-sub -mt-3 mb-4",children:[r.lastRace.name," · ",r.lastRace.circuit]}),e.jsx("div",{className:"space-y-1",children:r.lastRace.podium.map(s=>e.jsx(B,{pos:s.pos,color:j(s.teamId),name:`${s.first} ${s.last}`,sub:`${s.team} · ${s.time}`,points:s.points,wins:0,pct:s.points/(r.lastRace.podium[0].points||1)*100,lead:s.pos===1},s.code))}),r.lastRace.fastestLap&&e.jsxs("p",{className:"f1-note mt-3.5",children:["Fastest lap — ",r.lastRace.fastestLap.driver," ",r.lastRace.fastestLap.time]})]})}),e.jsx(m,{children:e.jsxs(x,{children:[e.jsx(k,{note:`${r.races.length} rounds`,children:"The calendar"}),e.jsx("div",{className:"space-y-1",children:r.races.map(s=>{const t=new Date(s.start).getTime()<Date.now(),c=d&&s.round===d.round;return e.jsxs("div",{className:`f1-cal${t?" f1-cal-past":""}${c?" f1-cal-next":""}`,children:[e.jsx("span",{className:"f1-pos",children:s.round}),e.jsxs("span",{className:"min-w-0 flex-1",children:[e.jsx("span",{className:"block text-[14.5px] leading-tight truncate",children:s.name}),e.jsxs("span",{className:"f1-sub block truncate",children:[s.locality,", ",s.country]})]}),e.jsx("span",{className:"f1-cal-date",children:R(s.start)})]},s.round)})})]})}),e.jsx(T,{}),e.jsx(m,{children:e.jsx(x,{children:e.jsxs("div",{className:"f1-credits",children:[e.jsxs("p",{children:["Film: ",e.jsx("b",{children:"AMD Radeon PRO × Blender"})," for the Mercedes-AMG Petronas F1 Team, marking eight consecutive constructors’ titles (2014–2021). Rendered with Blender on an AMD Radeon PRO W6800. All rights belong to their owners; it is used here as a fan tribute, trimmed and re-encoded for the web."]}),e.jsxs("p",{children:["Timing and standings from"," ",e.jsx("a",{href:"https://api.jolpi.ca/ergast/f1/",target:"_blank",rel:"noopener noreferrer",children:"Jolpica-F1"}),", the community successor to Ergast. Not affiliated with Formula 1, the FIA, or any team."]}),r.generated&&e.jsxs("p",{className:"f1-note",children:["Snapshot ",new Date(r.generated).toLocaleDateString("en-GB",{day:"numeric",month:"short",year:"numeric"}),h?" · standings refreshed live":""]})]})})})]})]}),e.jsx("style",{children:`
        .f1-root {
          --f1-red: #E10600;
          --f1-bg: #0A0A0C;
          --f1-card: #14141A;
