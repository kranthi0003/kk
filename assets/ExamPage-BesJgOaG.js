import{r as s,j as e,W as v}from"./index-B1SWiRcw.js";import j from"./supabase-CsW8ialo.js";const N="#C0392B",A="#2E2A26",S="#6A625B",z="#FBF7EE",B="https://fonts.googleapis.com/css2?family=Caveat:wght@500;600;700&display=swap",M="'Caveat', 'Segoe Script', 'Bradley Hand', cursive",i=[{n:1,marks:20,paper:"Paper I — Data Structures & Algorithms",q:"The candidate executed the following at 2 AM. Identify the fault.",code:`def revise(syllabus):
    if panic:
...
'hmm, that depends on a few factors…'`,opts:["A hallucination","A severe hallucination","Model collapse — roll back to the last good checkpoint","All of the above. Deprecate the model and retrain it on facts."],note:"Correct. Model deprecated."},{n:4,marks:15,paper:"Paper IV — Cloud Computing",q:"Attribute the spend below to the correct owner.",code:`$ aws ce get-cost --service caffeine
  ...
  Sep 15    380
  Sep 16    520
  Sep 17   1290`,opts:["The candidate, revising","The syllabus, expanding","A third party who keeps her talking past midnight","That same third party, who knows exactly what he did. Tag it to his account."],note:"Correct. Charged to him."},{n:5,marks:15,paper:"Section E — General Studies",q:"The candidate’s phone, throughout exam week, has been:",opts:["On Do Not Disturb","Face down, screen dimmed","Face down — but checked anyway, for one particular name","All of the above. The examiner has no further questions."],note:"Correct. No follow-up."},{n:6,marks:15,paper:"Bonus — Post-Deployment",q:"On successful completion of the above, the candidate is to be released to production at:",opts:["Sri Lanka — Colombo, to land and eat immediately","Sri Lanka — Kandy, for the lake and the tooth temple","Sri Lanka — Ella, for the Nine Arch Bridge and the blue train","Sri Lanka — Galle as well. All four. Nine days. Book it before the results are out."],note:"Correct. Approved. Book it."}],m=i.reduce((d,r)=>d+r.marks,0);function I({onBack:d}){const[r,h]=s.useState({}),[c,f]=s.useState(!1),u=s.useRef(null);s.useEffect(()=>{if(document.querySelector("link[data-hand-font]"))return;const t=document.createElement("link");t.rel="stylesheet",t.href=B,t.setAttribute("data-hand-font",""),document.head.appendChild(t)},[]);const g=s.useMemo(()=>i.filter(t=>r[t.n]!=null).length,[r]),p=s.useMemo(()=>i.reduce((t,a)=>t+(r[a.n]!=null?a.marks:0),0),[r]),l=g===i.length,b=s.useRef(!1);s.useEffect(()=>{!l||b.current||(b.current=!0,j.from("exam_answers").insert({answers:i.map(t=>({n:t.n,paper:t.paper,option:"abcd"[r[t.n]],answer:t.opts[r[t.n]]})),total:p}).then(({error:t})=>{t&&console.warn("[exams] answers not recorded:",t.message)}))},[l,r,p]),s.useEffect(()=>{if(!l||c)return;const t=setTimeout(()=>{f(!0);const a=u.current;a&&!window.matchMedia("(prefers-reduced-motion: reduce)").matches&&requestAnimationFrame(()=>{a.scrollIntoView({behavior:"smooth",block:"center"})})},520);return()=>clearTimeout(t)},[l,c]);const w=s.useCallback((t,a)=>{h(o=>o[t]===a?o:{...o,[t]:a})},[]),k=()=>{h({}),f(!1),window.scrollTo({top:0,behavior:"smooth"})},y=new Date().toLocaleDateString("en-GB",{day:"2-digit",month:"short",year:"numeric"});return e.jsxs("div",{className:"ex-root",children:[e.jsx("style",{children:E}),e.jsxs("div",{className:"ex-wrap",children:[e.jsxs("button",{onClick:d,className:"ex-back",children:[e.jsx("span",{"aria-hidden":"true",children:"←"})," Back"]}),e.jsxs("div",{className:"ex-sheet",children:[e.jsx("div",{className:"ex-rule","aria-hidden":"true"}),e.jsxs("header",{className:"ex-head",children:[e.jsx("p",{className:"ex-uni",children:"Work Integrated Learning Programme"}),e.jsx("h1",{className:"ex-title",children:"Mid‑Semester Examination"}),e.jsx("p",{className:"ex-sub",children:"Computer Systems · four papers · seven days of revision."}),e.jsxs("div",{className:"ex-meta",children:[e.jsxs("span",{children:["Papers: ",e.jsx("b",{children:"4"})]}),e.jsx("span",{className:"ex-dot","aria-hidden":"true",children:"·"}),e.jsxs("span",{children:["Max Marks: ",e.jsx("b",{children:m})]}),e.jsx("span",{className:"ex-dot","aria-hidden":"true",children:"·"}),e.jsxs("span",{children:["Pass Marks: ",e.jsx("b",{children:"irrelevant"})]})]}),e.jsxs("div",{className:"ex-roll",children:[e.jsx("span",{className:"ex-roll-label",children:"Roll No."}),e.jsx("span",{className:"ex-roll-box",children:e.jsx("span",{className:"ex-hand ex-roll-name",children:"Amrutha"})})]})]}),e.jsxs("section",{className:"ex-instr","aria-label":"Instructions to candidates",children:[e.jsx("p",{className:"ex-instr-h",children:"Instructions to the Candidate"}),e.jsxs("ol",{children:[e.jsx("li",{children:"All questions are compulsory. All answers are correct. This is not a trick."}),e.jsx("li",{children:"Answers may be written in any language — English, Telugu, SQL, or eye contact."}),e.jsx("li",{children:"Water bottles are permitted. Snacks are permitted. Self-doubt is confiscated at the door."}),e.jsx("li",{children:"Do not ask the invigilator for clarification — they have not read the syllabus either."}),e.jsx("li",{children:"Any candidate caught underestimating herself will be asked to leave the hall."})]})]}),e.jsx("div",{className:"ex-qs",children:i.map(t=>{const a=r[t.n]!=null;return e.jsxs("section",{className:`ex-q ${a?"is-done":""}`,children:[t.paper&&e.jsx("p",{className:"ex-paper",children:t.paper}),e.jsxs("div",{className:"ex-q-head",children:[e.jsxs("span",{className:"ex-q-n",children:["Q",t.n,"."]}),e.jsx("p",{className:"ex-q-t",children:t.q.split(`
`).map((o,n)=>e.jsxs(v.Fragment,{children:[n>0&&e.jsx("br",{}),o]},n))}),e.jsxs("span",{className:"ex-q-m",children:["[",t.marks,"]"]})]}),t.code&&e.jsx("pre",{className:"ex-code",children:t.code}),e.jsx("ul",{className:"ex-opts",children:t.opts.map((o,n)=>{const x=r[t.n]===n;return e.jsx("li",{children:e.jsxs("button",{type:"button",onClick:()=>w(t.n,n),"aria-pressed":x,className:`ex-opt ${x?"is-on":""}`,children:[e.jsx("span",{className:"ex-bub","aria-hidden":"true",children:"abcd"[n]}),e.jsx("span",{className:"ex-opt-t",children:o}),x&&e.jsx("span",{className:"ex-hand ex-tick","aria-hidden":"true",children:"✓"})]})},n)})}),e.jsx("p",{className:`ex-hand ex-note ${a?"is-in":""}`,"aria-live":"polite",children:a?`${t.note}  ${t.marks}/${t.marks}`:""})]},t.n)})}),e.jsxs("div",{className:"ex-total","aria-live":"polite",children:[e.jsx("span",{className:"ex-total-l",children:"Total"}),e.jsxs("span",{className:"ex-hand ex-total-n",children:[p,e.jsxs("span",{className:"ex-total-d",children:["/",m]})]})]}),e.jsx("div",{className:"ex-result",ref:u,children:l?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:`ex-stamp ${c?"is-in":""}`,role:"img","aria-label":`Stamped: All the best, Amrutha. Mid-semester, ${y}. Result: certain.`,children:[e.jsx("span",{className:"ex-stamp-top",children:"Office of Good Wishes"}),e.jsx("strong",{className:"ex-stamp-big",children:"All the Best"}),e.jsxs("span",{className:"ex-stamp-bot",children:["Amrutha · All Four Papers · ",y]}),e.jsx("span",{className:"ex-stamp-res",children:"Result: certain"})]}),e.jsx("p",{className:"ex-filed",children:"Answer sheet collected. The examiner has your paper."}),e.jsxs("div",{className:`ex-remark ${c?"is-in":""}`,children:[e.jsx("p",{className:"ex-remark-l",children:"Examiner's remarks"}),e.jsxs("p",{className:"ex-hand ex-remark-t",children:[m,"/",m," across all four papers. Not marked generously — there was simply nothing to deduct, because you're too good."]}),e.jsx("p",{className:"ex-hand ex-remark-t",children:"That is the joke over. Here is the real note: you are about to put half a semester away in seven days and still walk in steadier than people who started in July. You always do."}),e.jsx("p",{className:"ex-hand ex-wish",children:"Go get them, A!"}),e.jsx("p",{className:"ex-hand ex-sign",children:"— K"})]}),e.jsxs("button",{onClick:k,className:"ex-reset",children:["Attempt again (you'll still get ",m,")"]})]}):e.jsxs("p",{className:"ex-await",children:[g," of ",i.length," attempted — the examiner is waiting with the stamp ready."]})})]}),e.jsx("p",{className:"ex-foot",children:"No actual examination board was consulted in the making of this page."})]})]})}const E=`
.ex-root {
  --red: ${N};
  --ink: ${A};
  --soft: ${S};
...
.ex-hand { font-family: ${M}; font-weight: 600; }
