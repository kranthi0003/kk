  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? 'bg-background/80 backdrop-blur-xl shadow-lg border-b border-border/10'
          : 'bg-transparent'
      }`}
      role="navigation"
    ...
    >
      ...
      <div className="hidden lg:block bg-background/90 backdrop-blur-xl border-t border-border/10 border-b border-b-border/30">
