...
const PROMPTS = {
  mild: {
    truth: [
      "Who was your very first crush — and how did you act around them?",
      "What's the silliest thing you've ever done to get someone's attention?",
      "What was your first 'real' relationship like — even if it was just school?",
      "How old were you when you had your first proper kiss? Where was it?",
      "What's the longest crush you've ever had on someone?",
      "Have you ever liked someone and never told them? Still feel that way?",
      "What's your usual 'type' — looks-wise and personality-wise?",
      "Who's the last person who genuinely made you blush?",
      "What's the first thing you notice about someone you find attractive?",
      "What was your most awkward 'first move' attempt?",
      "Who's the last person you texted 'good night'? Why them?",
      "What's the most ridiculous thing you've done to impress a crush?",
      "What's the cutest gift you've ever received from someone you liked?",
      "Have you ever fallen for someone in the first 5 minutes of meeting them?",
      "What's a small thing someone did that made you think 'I really like this person'?",
      "Have you ever had a crush on someone in your friend circle? Don't name them.",
      "What's your usual go-to flirting move — even if it's bad?",
      "What's the cheesiest line that has ever actually worked on you?",
      "What's the most embarrassing nickname someone close has ever called you?",
      "Have you ever lied about your relationship status to seem more interesting?",
    ],
    dare: [
      "Show the last 'good night' or 'good morning' text you sent to anyone.",
      "Read out the last romantic song you saved or played.",
      "Show the most flattering selfie in your camera roll.",
      "Open Instagram — show the last person you searched for.",
      "Sing the chorus of any love song you'd put on a date playlist.",
      "Show your phone wallpaper AND say who/what it reminds you of.",
      "Open your Notes app — read out anything that looks remotely romantic.",
      "Show the last meme you sent that could be considered flirty.",
      "Recite the cheesiest line from a Bollywood/Tollywood movie with full conviction.",
      "Show the first photo in your gallery from this month.",
      "Read the last DM you got from anyone (skip private ones).",
      "Show your most-played song this month — and explain why.",
    ],
  },

  // ─── MEDIUM: love life deep-dive (about HER — exes, what she looks for, regrets) ──
  medium: {
    truth: [
      "Tell us about your last relationship — what was the best part?",
      "Tell us about your last relationship — what was the WORST part?",
      "Why did your last 'thing' with someone actually end?",
      "Who's the one ex you'd quietly check on if you saw their name pop up?",
      ...
      "What's a lie you've told a partner that you got away with?",
      "What's the most you've ever changed yourself for someone?",
      "What's the longest you've gone without talking to a partner during a fight?",
      "Have you ever ghosted someone? What was your reason — be honest?",
      "What's the most 'I should have known better' relationship sign you ignored?",
      "What's the silliest reason you ended things with someone?",
      "Have you ever liked someone way more than they liked you? How obvious were you?",
      "What's a green flag in a person that instantly makes you trust them?",
      "What's a red flag you used to ignore that you wouldn't anymore?",
      "How do you usually find out you're catching feelings for someone?",
      "What's something you wish past partners had done differently?",
      "Have you ever fallen for someone you knew was completely wrong for you?",
      "What's the biggest fight you've had over something silly?",
      "What's your worst dating app horror story?",
      "What's the cringiest thing you've done after a breakup?",
      "Have you ever rebounded with someone? Did it help?",
      "What's the most romantic thing anyone has ever done for you — be specific?",
      "What's something a partner did that genuinely made you fall harder?",
      "Have you ever been the 'almost' for someone — and how did that end?",
      "Have you ever caught feelings for someone after just one conversation?",
    ],
    dare: [
      "Show the last name in your 'recently deleted' contacts or call log.",
      "Read out the last text exchange you had with your most recent ex (skip private bits).",
      "Show how many people you've blocked on WhatsApp / Instagram.",
      "Show your Spotify/JioSaavn most-played romantic song this month.",
      "Read a romantic line from any movie/book that genuinely moves you.",
      "Show the last person you screenshotted from any app.",
      "Open Instagram — show the last 3 profiles you visited.",
      "Show your Insta saved folder named 'love', 'romance', 'aww', or whatever's closest.",
      "Show the most romantic picture in your camera roll.",
      "Read a romantic Bollywood/Tollywood dialogue out loud, full intent.",
      "Tell us the most romantic moment from your dating history — full story.",
    ],
  },
