...
function NPC() {
  ...
  return (
    <group>
      ...
      {/* Status pill */}
      <Html position={[0, sleeping ? 0.85 : (activity.id === "gym" ? 1.7 : 1.55), 0]} center distanceFactor={6}>
        <div style={{
          padding: "3px 10px",
          borderRadius: 10,
...
function getActivity() {
  ...
  // 0-6: sleep, 7-8: coffee, 9-12: work, 13: lunch, 14-18: work, 19-20: gym, 21-23: ps5
