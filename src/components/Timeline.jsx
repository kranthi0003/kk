...
const GROUPS = [
  {
    ...
    items: [
      ...
      { name: 'GitHub Foundations', slug: 'github-foundations', when: 'Apr 2026' },
      { name: 'Couchbase Certified — Administrator', slug: 'couchbase-admin', when: 'Feb 2026' },
      { name: 'Couchbase Certified — Python Developer', slug: 'couchbase-python', when: 'May 2025' },
      { name: 'Couchbase Certified — Architect', slug: 'couchbase-architect', when: 'Apr 2025' },
      { name: 'AWS Solutions Architect — Associate', slug: 'aws-saa', when: 'Jun 2021' },
    ],
  },
  {
    status: 'In progress',
