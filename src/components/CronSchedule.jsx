...
export default function CronSchedule() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('toggle-cron-schedule', toggle)
    return () => window.removeEventListener('toggle-cron-schedule', toggle)
  }, [])
      ...
      <div className="w-full max-w-lg max-h-[85vh] flex flex-col rounded-2xl bg-background border border-border shadow-2xl">
        <div className="flex items-center justify-between px-5 py-3 border-b border-border">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-semibold">Actions Cron Scheduler</h2>
          </div>
